...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'from_user_id',  CHtml::listData(User::model()->findAll(), 'id', 'email')); ?>
		<?php echo $form->error($model,'from_user_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'to_user_id'); ?>
		<?php echo $form->dropDownList($model,'to_user_id',CHtml::listData(User::model()->findAll(), 'id', 'email')); ?>
